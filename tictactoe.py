...
class TicTacToe:
    ...
    def log_game_result(self, winner):
        ...
        first_player = self.board[self.first_move[0]][self.first_move[1]]
        first_move_outcome = self.determine_first_move_outcome(winner, first_player)
        ...
        log_data = {
            ...
            'First Move Player': first_player,
            'First Move Outcome': first_move_outcome
        }
    ...
    def determine_first_move_outcome(self, winner, first_move_player):
        """ Determine the outcome for the player who made the first move. """
        if winner == first_move_player:
            return 'win'
        elif winner == 'draw':
            return 'draw'
        elif winner is None:
